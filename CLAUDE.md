...
- Domain primitives in `@haru/types`: family-stage (`deriveStage`, boundaries `[12,48,156]` months) and entitlement tiers (`PlanTier` free/plus/family)
