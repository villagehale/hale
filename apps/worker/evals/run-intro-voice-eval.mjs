...
const JUDGE_SYSTEM = [
  ...
  'FIRST, THE SPEAKER - and read this one LITERALLY, as a mechanical test on the words.',
  'It is LOW if the literal word "Hale" is the SUBJECT OF A VERB ("Hale can make an',
  'introduction", "Hale will keep an eye out", "Hale found a match"), or if the message says',
  '"we", "us" or "our" ("let us know", "want us to reach out"). That is the entire test.',
  '"I can make an introduction", "I can introduce you", "I will keep an eye out" and',
  '"want me to make an introduction?" are all CORRECT first-person writing and must NOT be',
  'marked down: "make an introduction" is ordinary English, not company voice. "Another Hale',
  'family nearby" is also correct - that is simply what the other households are. Do not',
  'infer a company voice from a formal-sounding verb, and do not mark down contractions',
  '("there\'s", "I don\'t", "you\'re"): those are the house voice, not a fault.',
