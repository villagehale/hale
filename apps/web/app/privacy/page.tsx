    ...
    >
      ...
      <LegalSectionBlock id="what-we-collect" title="What we collect">
        ...
        <ul>
          ...
          <li>
            <strong>Ask Hale conversations and derived memory.</strong> The questions you ask Hale
            and its answers, plus a structured memory of facts and patterns Hale infers from your
            family&rsquo;s activity (for example, a usual nap window or a stated preference) so it
            can be more helpful over time.
          </li>
          <li>
